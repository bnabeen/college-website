        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-4">
                <?php if (!empty($course['image'])): ?>
                    <img src="assets/uploads/courses/<?php echo htmlspecialchars($course['image']); ?>" alt="<?php echo htmlspecialchars($course['name']); ?>" class="img-fluid rounded shadow">
                <?php else: ?>
                    <img src="assets/uploads/courses" alt="Image" class="img-fluid rounded shadow">
                <?php endif; ?>
            </div>
